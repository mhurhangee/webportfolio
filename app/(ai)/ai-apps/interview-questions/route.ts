...
const INTERVIEW_CONFIG = {
  job: {
    prompt: "Create interview questions to assess the candidate's skills, experience, and fit for the role.",
  ...
  customer: {
    prompt: "Create customer interview questions to gather feedback, understand needs, and improve products/services.",
...
export async function POST(req: Request) {
  try {
    ...
    const { role, missionOutcome, background, interviewType, previousQuestions = [] } = await req.json()
