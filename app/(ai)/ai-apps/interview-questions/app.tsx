...
const INTERVIEW_DESCRIPTIONS: Record<InterviewType, string> = {
    ...
    customer: "Questions to gather feedback from customers, understand their needs, and improve products or services.",
    behavioral: "Questions that assess past experiences, decision-making processes, and problem-solving abilities.",
}
...
export default function InterviewQuestionsPage() {
    ...
    const moveQuestion = (id: string, direction: "up" | "down") => {
        ...
        if (index >= 0 && newIndex >= 0 && index < newQuestions.length && newIndex < newQuestions.length) {
                            ...
                            <div className="space-y-3">
                                ...
                                <div>
                                    ...
                                    <Input
                                        id="missionOutcome"
                                        name="missionOutcome"
                                        placeholder="e.g., Building a web app, TV Interview"
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        id="background"
                                        name="background"
                                        placeholder="Additional context about the interview"
                                ...
                                <div className="flex gap-2">
                                    <Button onClick={generateQuestions} disabled={isLoading || !formData.role} className="flex-1">
                                        {isLoading
                                            ? "Generating..."
                                            : questions.length > 0
                        ...
                        {isLoading && (
                            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                                <div className="space-y-2 mt-4">
                                    <p className="text-sm text-muted-foreground mb-2 animate-pulse">Generating new questions...</p>
                                    {[...Array(3)].map((_, i) => (
